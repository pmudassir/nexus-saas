...
-- CreateEnum
CREATE TYPE "DomainType" AS ENUM ('APP', 'SITE');

-- CreateEnum
CREATE TYPE "TenantRole" AS ENUM ('TENANT_ADMIN', 'TENANT_USER', 'CUSTOM');
...
CREATE TABLE "Domain" (
    ...
    "type" "DomainType" NOT NULL DEFAULT 'APP',
...
-- CreateIndex
CREATE UNIQUE INDEX "Domain_domain_type_key" ON "Domain"("domain", "type");
...
-- AddForeignKey
ALTER TABLE "Automation" ADD CONSTRAINT "Automation_creatorId_fkey" FOREIGN KEY ("creatorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
